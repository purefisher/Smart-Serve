...
\newpage
    ...
    \hline
        ...
        \toprule
        \midrule
        01/04/23 & Max Turek & Updated document to reflect issues from other teams. Removed ODR7, edited PR7 \&\ PR8, rationale added for QR1 and citation added for HSR3\\
        \bottomrule
        \end{tabularx}
    \end{table}
